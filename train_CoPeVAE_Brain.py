...
from AutoEncoder.dataset.BrainMRI_data import *
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cache', default=0.8, type=float)
    ...
    args.result_dir = '../result/CopeVAE/Brain/'
    os.makedirs(args.result_dir, exist_ok=True)
    args.log_dir = args.result_dir + '/log/'

    os.makedirs(args.log_dir, exist_ok=True)
    args.model_dir = 'model_save/CopeVAE/Brain/' + today_date + '/'

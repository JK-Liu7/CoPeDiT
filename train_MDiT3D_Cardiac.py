...
def train(args, autoencoder, DiT):
    ...
    # define infer
    inferer = inferer_DiT_Cardiac.LatentDiffusionInferer(scheduler_ddpm, scale_factor=scale_factor)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--DiT", default='MDiT3D-S/2', type=str)
    ...
    args.model_dir = 'model_save/MDiT3D/Cardiac/' + args.dataset + '/' + str(args.missing_num) + '/' + today_date + '/'
